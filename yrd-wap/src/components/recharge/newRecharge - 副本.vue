<template>
  <div class="recharge-wrapper border-none">
        ...
        <div class="access-input-box border-b-none">
          ...
          <div class="input-box">
            <div class="input-box-wrapper">
              <input class="access-input-sum" type="tel" v-model="rechargeCode" maxLength="8" placeholder="请输入验证码">
            </div>
          </div>
          <div class="recharge-input-code-btn" :class="{'not-click': !codeClick}" v-html="codeBtnTxt" @click.stop="getRhCode"></div>
        </div>
      </div>
      <!-- <div class="recharge-slot" slot="recharge-pay-type">
        <div class="recharge-slot-item border-1px-b" v-if="bankName.length > 0">
