  ...
  <div class="report-wrapper-box">
    ...
    <div class="report-group">
      <div class="report-wrapper">
        <div class="swiper-container" id="ptswiper">
            ...
            <div class="swiper-slide">
              <div class="swiper-grounp-2-content">
                <div class="title-2 animated" :class="{bounceIn: activeIndex === 1}">
                  <img src="./minImg.png" width="100%" class="min-img">
                  <img src='./minImg-2.png' width="100%">
                </div>
              ...
              <div class="swiper-grounp-2-content">
                ...
                <ul class="swiper-grounp-6">
                  <li class="progress-circle" v-for="(item, index) in system" :class="item.icon">
                  	<div class="progress-img-wrappper">
                  		<div class="progress-img-box" :class="item.icon"></div>
                  	</div>
                    <svg width="90" height="90" viewBox="0 0 90 90" version="1.1" xmlns="http://www.w3.org/2000/svg" style="margin-left: 17%;">
...
//      this.sy3 = window.setInterval(this._ani(3), 30)
      ...
      _swiper3() {
        let _this = this
        this.ptswiper = new Swiper('#ptswiper', {
      ...
      .report-wrapper
        ...
        .swiper-container
          ...
          .boy
            ...
            background: -moz-linear-gradient(top, #406ff1, #7899f5)
            background: -webkit-gradient(linear, 0 0, 0 bottom, from(#406ff1), to(#7899f5))
          .girl
            position: absolute
            left: 69.5%
            bottom: 0
            ...
            font-size: 10px
            border-radius: 10px 10px 0 0
            background: -moz-linear-gradient(top, #7640f1, #9c74f5)
            background: -webkit-gradient(linear, 0 0, 0 bottom, from(#7640f1), to(#9c74f5))
          .boy .desc, .girl .desc
            display: block
            position: absolute
            left: 50%
          ...
          .icon-app .system-percent
            background-size: 20% 300%
